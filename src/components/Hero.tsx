  ...
  return (
    ...
    >
      ...
      <div className="relative z-20">
        <motion.div className="container mx-auto px-4 md:px-6 lg:px-8" variants={heroContainer}>
          <motion.div className="max-w-4xl mx-auto text-center py-12 md:py-20" variants={heroChild}>
            <motion.h1
            ...
            <motion.p className="text-lg sm:text-xl md:text-2xl text-slate-100 mb-3" variants={heroChild}>
              25 años fabricando calidad para el Perú
            </motion.p>

            <motion.p
              className="text-base sm:text-lg md:text-xl text-slate-200 mb-8 max-w-3xl mx-auto"
              variants={heroChild}
            >
            ...
            <motion.div className="flex flex-col sm:flex-row gap-4 justify-center" variants={heroChild}>
              <Link to="/productos">
