        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8 font-body text-lg leading-relaxed">
            <p className="text-foreground first-letter:text-6xl first-letter:font-display first-letter:font-bold first-letter:float-left first-letter:mr-3 first-letter:leading-none first-letter:text-primary">
              Las servilletas y papel CLASICA son marcas de la empresa Papeleras Latinoamericanas S.A.C, una empresa peruana con más de 25 años de historia y experiencia produciendo y comercializando productos de alta calidad, reconocidos en el mercado peruano como productos y diseños para el negocio y hogar.
            </p>
